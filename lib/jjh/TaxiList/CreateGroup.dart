                ...
                children: [
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              width: 113 * PX,
                              child: Stack(
                                  children: [Center(child: Text("부산은행"))]),
                              decoration: BoxDecoration(
                                  border: Border.all(
                                    width: 0.5 * PX,
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              width: 113 * PX,
                              child: Stack(
                                  children: [Center(child: Text("부산대역"))]),
                              decoration: BoxDecoration(
                                  border: Border.all(
                                    width: 0.5 * PX,
                                    color: Color.fromRGBO(118, 118, 128, 0.12),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              width: 113 * PX,
                              child: Stack(
                                  children: [Center(child: Text("부산대정문"))]),
                              decoration: BoxDecoration(
                                  border: Border.all(
                                    width: 0.5 * PX,
                                    color: Color.fromRGBO(118, 118, 128, 0.12),
                  ...
                  Row(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(
                            left: GetRealWidth(pixel: 31, context: context)),
                        child: Text(
                          "대화방 링크추가",
                  ...
                  Container(
                    width: GetRealWidth(pixel: 331, context: context),
