...
class TaxiStatusBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin:
          RealLTRB(left: 24.55, top: 11, right: 0, bottom: 0, context: context),
        ...
        children: [
          Row(
            ...
            children: [
              Container(
                ...
                margin: RealLTRB(
                    left: 23, top: 27, right: 0, bottom: 0, context: context),
                child: Image.asset(
                    "assets/images/TaxiHistory/icon_blue_circle.png"),
              ),
              Container(
                margin: RealLTRB(
                    left: 15, top: 24, right: 0, bottom: 0, context: context),
              ...
              BasicButton(
                ...
                buttonStyle: ElevatedButton.styleFrom(
                    backgroundColor: Color(0xffE3EBF7),
          ...
          Container(
              ...
              child: Wrap(
                ...
                children: [
                  IconTaxiCurrent(order: 0, text: "부산은행"),
                  IconTaxiCurrent(order: 1, text: "명륜역"),
                  IconTaxiCurrent(order: 2, text: "교대역"),
                  IconTaxiCurrent(order: 3, text: "서면역"),
                  IconTaxiCurrent(order: 4, text: "송정역"),
                ],
              )),
        ],
      ),
...
class _TaxiHistorySearchBarState extends State<TaxiHistorySearchBar> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: myHeight,
      margin:
          RealLTRB(left: 21, top: 77, right: 0, bottom: 0, context: context),
      child: Row(
        children: [
...
class TaxiHistoryBox extends StatelessWidget {
  ...
  TaxiHistoryBox(
    ...
    textPeople = Text(
      peopleCount,
      style: textstyleBoxDescrHalfVis,
    );
    textHistoryState = Text(
      historyState,
      style: textstyleBoxDescrHalfVis,
    );
    textTime = Text(
...
class TaxiHistoryListState extends State<TaxiHistoryList> {
  ...
  final List<Map<String, dynamic>> taxiHistory = [
    ...
    {
      'date': '2023.02.11',
      'routeTitle': '부산대정문-온천역',
      'peopleCount': 2,
      'historyState': '정산완료',
      'time': '17:40',
      'route': '부산대정문-온천역-롯데백화점'
    },
    {
      'date': '2023.01.27',
      'routeTitle': '부산대역-부곡동',
      ...
      'historyState': '정산완료',
      'time': '11:50',
      'route': '부산대역-부곡동-해운대-광안리'
    },
    {
      'date': '2023.01.03',
      'routeTitle': '부산은행-서동고개',
      'peopleCount': 3,
      'historyState': '정산완료',
      'time': '08:20',
      'route': '부산은행-서동고개-센텀시티-벡스코'
    },
    {
      'date': '2022.12.15',
      'routeTitle': '부산대정문-광안리',
      'peopleCount': 4,
      'historyState': '정산완료',
      'time': '12:30',
      'route': '부산대정문-광안리-대구-서울-개성'
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: Container(
        ...
        height: myHeight,
        margin:
            RealLTRB(left: 21, top: 0, right: 0, bottom: 0, context: context),
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                margin: RealLTRB(
                    left: 25, top: 35, right: 0, bottom: 0, context: context),
                child: Text(
                  "확인",
                  style: SimpleTextStyle(size: 25, weight: FontWeight.w700),
                ),
              ),
              Container(
                margin: RealLTRB(
                    left: 25, top: 25, right: 0, bottom: 0, context: context),
                child: Text(
                  "탑승 현황",
                  style: SimpleTextStyle(size: 18, weight: FontWeight.w600),
                ),
              ),
              TaxiStatusBox(
                status: "참여중이에요",
