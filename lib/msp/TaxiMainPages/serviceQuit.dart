          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                height: GetRealHeight(pixel: 70, context: context),
                child: Container(
                    margin: RealLTRB(left: 20, top: 20, right: 0, bottom: 0, context: context),
              ...
              Container(
                ...
                child: Container(
                    margin: RealLTRB(left: 20, top: 20, right: 0, bottom: 0, context: context),
                    child: Text("참여 중인 택시팟이 있을 경우, 탈퇴가 제한됩니다.\n닉네임, 회원정보 등 데이터는 삭제되며, 복구 할 수 없습니다.\n탈퇴 시 신데렐라 서비스 이용에 제한이 생깁니다.", style: SimpleTextStyle(size: 17.5, weight: FontWeight.w400, lineSpacing: 2))
                ),
              ),
              Container(
                alignment: Alignment.bottomCenter,
                height: GetRealHeight(pixel: 290, context: context),
                child: Container(

                    child: Text("그동안 신데렐라를 이용해 주셔서 감사합니다.", style: SimpleTextStyle(size: 19, weight: FontWeight.w400))
                ),
              ),
              RealSizedBox(width: 0, height: 27),
